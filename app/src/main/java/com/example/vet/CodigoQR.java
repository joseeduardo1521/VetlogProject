...
public class CodigoQR extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameraBtn = findViewById(R.id.camaraputo);
        ...
        scanBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(imageUri == null){
                    Toast.makeText(CodigoQR.this,"Toma primera imagen",Toast.LENGTH_SHORT).show();
                }else{
            ...
            Task<List<Barcode>> barcodeResult = barcodeScanner.process(inputImage)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                         Toast.makeText(CodigoQR.this,"Fallo al escanear"+e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });

        } catch (IOException e) {
           // e.printStackTrace();
            Toast.makeText(this, "fallo en"+e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
        ...
        for(Barcode barcode: barcodes){
            ...
            switch (valueType){
                ...
                case Barcode.TYPE_CONTACT_INFO:{
                    ...
                    String phones= ""+typeContact.getPhones();
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    ...
                    if(result.getResultCode() == Activity.RESULT_OK){
                        ...
                        Toast.makeText(CodigoQR.this,"Cancelado",Toast.LENGTH_SHORT).show();;
                    }

                }
            }
    );
    private void pickImagenCamera(){
            ...
            case CAMERA_REQUEST_CODE:{
                if(grantResults.length > 0){
                    ...
                    if(cameraAccepted && storageAccepted){
                        ...
                        Toast.makeText(this,"camara y almacenamiento requieren permisos..", Toast.LENGTH_SHORT).show();
            ...
            case STORAGE_REQUEST_CODE:{
                if(grantResults.length>0){
                    ...
                    if(storageAccepted){
                        ...
                        Toast.makeText(this,"almacenamiento requieren permisos..", Toast.LENGTH_SHORT).show();
                    }
                }
            }
            break;
