...
public class MenuSec extends AppCompatActivity {
    ...
    private View cardCerSesion, cardAgregarMas, cardVisualCita, cardAdop, cardVacun;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cardVacun = (View) findViewById(R.id.D6);
        ...
        cardAgregarMas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gesMascotas = new Intent(MenuSec.this,gesMacotasActivity.class);
        ...
        cardAdop.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent adp = new Intent(MenuSec.this,mostrarAdopcion.class);
                startActivity(adp);
            }
        });
        cardVacun.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent vacu = new Intent(MenuSec.this,mostrarCamp.class);
                startActivity(vacu);
            }
        });
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    cerrarSesion();
                                                    Toast.makeText(MenuSec.this, "Inicie sesion nuevamente", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                            } else
    ...
    private void  actualizarUsu(String address, String name, String phone){
        ...
        mDatabase.child("Usuario").child(idu).updateChildren(updates).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(MenuSec.this, "Datos Actualizados", Toast.LENGTH_SHORT).show();
                    if(!(image_url == null)) {
                        subirPhoto(image_url, token);
                    }
                }else
                    Toast.makeText(MenuSec.this, "Error al actualizar datos", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void subirPhoto(Uri image_url, String token) {
        ...
        reference.putFile(image_url).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                if (uriTask.isSuccessful()){
                    uriTask.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(MenuSec.this, "Imagen cargada", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(MenuSec.this, "Error al cargar foto", Toast.LENGTH_SHORT).show();
            }
        });
    }
