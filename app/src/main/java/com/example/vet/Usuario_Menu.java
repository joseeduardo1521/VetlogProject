...
public class Usuario_Menu extends AppCompatActivity {
        ...
        mDatabase.child("Usuario").child(id).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Glide.with(Usuario_Menu.this).load(photo).into(updImage);
                }
            }
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    cerrarSesion();
                                                    Toast.makeText(Usuario_Menu.this, "Inicie sesion nuevamente", Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                        });
                            } else
    ...
    private void  actualizarUsu(String address, String name, String phone){
        ...
        mDatabase.child("Usuario").child(idu).updateChildren(updates).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(Usuario_Menu.this, "Datos Actualizados", Toast.LENGTH_SHORT).show();
                    if(!(image_url == null)) {
                        subirPhoto(image_url, token);
                    }
                }else
                    Toast.makeText(Usuario_Menu.this, "Error al actualizar datos", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void subirPhoto(Uri image_url, String token) {
        ...
        reference.putFile(image_url).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                if (uriTask.isSuccessful()){
                    uriTask.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(Usuario_Menu.this, "Imagen cargada", Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(Usuario_Menu.this, "Error al cargar foto", Toast.LENGTH_SHORT).show();
            }
        });
    }
